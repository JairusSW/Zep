...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!args.length) {
        console.log(chalk_1.default.bold.blueBright("Zep") +
            " is a homebrew compiler built from the ground up." +
            "\n");
        console.log(chalk_1.default.bold("Usage: zpc <command> " + chalk_1.default.cyanBright("[...flags]") + " [...args]") + "\n");
        console.log(chalk_1.default.bold("Commands:") + "\n");
        console.log(`  ${chalk_1.default.bold.blueBright("run")}    ${chalk_1.default.dim("./main.zp")}                    Run a Zep program`);
        console.log(`  ${chalk_1.default.bold.blueBright("build")}  ${chalk_1.default.dim("./main.zp -o ./main.wasm")}     Compile a Zep program to WebAssembly`);
        console.log(`  ${chalk_1.default.bold.blueBright("init")}                                Initialize a Zep project`);
    }
    ...
    function build() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const input = args[1];
            console.log(`${chalk_1.default.blueBright("Zep Compiler")} ${chalk_1.default.dim("(0.0.0)")}`);
            ...
            console.log(chalk_1.default.dim("Done in " + (Date.now() - start) + "ms"));
        });
    }
}))();
