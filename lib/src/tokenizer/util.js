...
function isPunctuation(char, position) {
  switch (char) {
    case ";": {
      return new tokendata_1.TokenData(
        token_1.Token.Semi,
        ";",
        position.toRange(),
      );
